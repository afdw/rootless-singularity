...
archlinux-bootstrap-x86_64.tar.gz:
	wget -O archlinux-bootstrap-x86_64.tar.gz https://geo.mirror.pkgbuild.com/iso/latest/archlinux-bootstrap-x86_64.tar.gz

fakeroot-x86_64.pkg.tar.zst:
	wget -O fakeroot-x86_64.pkg.tar.zst https://archlinux.org/packages/core/x86_64/fakeroot/download/

root.x86_64: archlinux-bootstrap-x86_64.tar.gz fakeroot-x86_64.pkg.tar.zst
...
clean:
	...
	rm -rf busybox rootless.sif archlinux-bootstrap-x86_64.tar.gz fakeroot-x86_64.pkg.tar.zst root.x86_64 fakeroot-x86_64 rootless-singularity-install
